...
struct Transanction : Identifiable, Decodable, Hashable{
    let id: Int
    let date: String
    ...
    var merchant: String
    let amount: Double
    let type: TransanctionType.RawValue
    var categoryId: Int
    var category: String
    let isPending: Bool
    var isTransfer: Bool
    ...
    var signedAmount : Double {
        return type==TransanctionType.credit.rawValue ? amount : -amount
    }
